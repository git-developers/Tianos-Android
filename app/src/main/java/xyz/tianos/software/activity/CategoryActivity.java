...
public class CategoryActivity extends BaseActivity {
    ...
    private void initialize() {
        pointOfSaleController = new PointOfSaleController(CategoryActivity.this);
    ...
    private void populateList() {
        ...
        if(listObject != null) {
            listView.setAdapter(new PointOfSaleAdapter(CategoryActivity.this, listObject));
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> a, View v, int position, long id) {
                    Object o = listView.getItemAtPosition(position);
                    PointOfSale pointOfSale = (PointOfSale) o;
                    Utils.shortToast(CategoryActivity.this, "Seleccionado: " + pointOfSale.getName());
                }
            });
        }
